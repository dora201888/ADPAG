...
Nmiss_c9_c35 | number of NAs from the L5hr_ENMO_mg_0-24hr column to the last column in the part2_daysummary.csv file in the GGIR output
...
part7b_studyname_all_features_1_day.csv | Raw data of all features  
part7b_studyname_all_features_2_dayclean.csv | Keep sample with valid ENMO inputs
part7b_studyname_all_features_2_dayclean.csv.log | Log file of each variable of part5b_studyname_all_features_2_dayclean.csv
plot_part7b_studyname_all_features_2_dayclean.csv.pdf | Plot of each variable of part5b_studyname_all_features_2_dayclean.csv
part7b_studyname_all_features_3_subject.csv | Average variable at the subject level
part7b_studyname_all_features_3_subject.csv.log | Log file of each variable of part5b_studyname_all_features_3_subject.csv
plot_part7b_studyname_all_features_3_subject.csv.pdf | Plot of each variable of part5b_studyname_all_features_3_subject.csv
part7b_studyname_all_features_4_subjectSD.csv | subject level SD of each feature
...
part7d_weekday_studyname_all_features_3_subject.csv | subject level mean of each feature on weekday
...
part7d_weekend_studyname_all_features_3_subject.csv | subject level mean of each feature on weekend
...
# Citing postGGIR  
   +  Guo W., Leroux A., Zipunnikov V., Merikangas K.R. (2021) postGGIR: An Open-Source R/R-Markdown Package for Accelerometer Data Processing after Running GGIR. (Manuscript)  
...
# Websites  
   +  postGGIR download: https://CRAN.R-project.org/package=postGGIR 

   +  postGGIR vignette: https://cran.r-project.org/web/packages/postGGIR/vignettes/postGGIR.html

   +  Example data and documents: https://github.com/dora201888/postGGIR
